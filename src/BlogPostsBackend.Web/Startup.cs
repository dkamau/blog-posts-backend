...
using BlogPostsBackend.Infrastructure;
...
namespace BlogPostsBackend.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = Environment.GetEnvironmentVariable("BlogPosts_DATABASE_CONN");
            if (string.IsNullOrEmpty(connectionString))
            {
                ...
                if(dbConnectionStrings != null)
                    connectionString = dbConnectionStrings.MSSQL; //Configuration.GetConnectionString("DefaultConnection"); //Configuration.GetConnectionString("SqliteConnection");
            }
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Blog Posts", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Blog Posts V1");
            });
