...
using BlogPostsBackend.Core.Specifications.UserSpecifications;
...
namespace BlogPostsBackend.Core.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        {
            string frontEndLink = Environment.GetEnvironmentVariable("BlogPosts_FRONTEND_LINK");
            ...
            await SendEmail(user, "handshake", "Welcome to Blog Posts", message, link, "Confirm Account");
        }
